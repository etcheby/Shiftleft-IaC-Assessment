  ...
  stages {
    ...
    stage('Shifleft SAST Terraform IaC-Assessment') {
      steps {
        ...
        sh 'shiftleft iac-assessment -D -p IaC-Assessment/aws -r -64 -s critical'
      }
    }
    ...
    stage('Shifleft SourceGuard') {
      steps {
        ...
        sh 'shiftleft sourceguard -D --src IaC-Assessment/aws'
      }
    }
